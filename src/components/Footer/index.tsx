...
import LogoMatchImg from '../../../public/LogoMatch.png'
        ...
        <div id="WeAre" className="w-full bg-white">
            <div className="w-full mx-auto items-center pt-5 pb-10 flex flex-col text-center text-purple-store md:min-h-screen md:pt-10 md:flex-row md:text-left md:w-5/6">
                <div className="w-1/2 relative pb-5">
                    ...
                    {/* <img className="mx-auto" src="/LogoMatch.png"></img> */}
                </div>
                <div className="flex flex-col w-4/5 gap-5 md:w-1/2 md:pb-5">
                    <div>
                        ...
                        <h2 className="text-3xl font-semibold text-button">
                            BUYPHONE
                        </h2>
                    </div>
            ...
            <div className="flex flex-col items-center text-purple-store bg-white shadow-[0_-5px_15px_-5px_rgba(0,0,0,0.3)] md:p-11">
                ...
                <div className="flex justify-center p-2 flex-col items-center md:flex-row">
                    ...
                    <p className="mr-3">
                        <a href="https://wa.me/5518997188537">
                            (18) 99718-8537
                        </a>
                    </p>
                </div>
