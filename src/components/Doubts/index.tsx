export function Doubts() {
    return (
        <div className="w-full bg-dark">
            <div className="w-5/6 mx-auto pb-24 flex flex-col items-center min-h-screen relative">
                <div className="pt-24 pb-10 flex flex-col items-center md:pt-24">
                    <h1 className="text-[5vw] text-white opacity-10 font-extrabold absolute leading-3">
                        DÚVIDAS FREQUENTES
                    </h1>
