...
export function Content() {
    ...
    return (
        <div id="Experience" className="w-full bg-dark">
            <div className="w-5/6 mx-auto flex flex-col items-center justify-between pt-20 gap-20 md:flex-row md:items-start md:gap-0">
                ...
                <div className="relative w-full md:w-1/3 md:mt-10">
                    <div className="bg-[url('/Ellipse18.png')] bg-no-repeat bg-local bg-cover -mt-14 absolute p-28"></div>
                    <div className="flex flex-col pr-[30px] h-[200px] justify-between">
                        <div className="flex items-center md:items-start md:flex-col">
                            <div className="h-10 w-10 flex justify-center items-center bg-button rounded-xl">
            ...
            <div className="w-5/6 flex mx-auto items-center pb-10 flex-col relative pt-10 md:pt-40">
                <h1 className="text-[7vw] text-white opacity-10 font-extrabold md:absolute md:leading-3">
                    COMO FUNCIONA?
                </h1>
            ...
            <div className="w-5/6 flex mx-auto border border-[#ffffff44] rounded-xl h-full">
                <div className="flex flex-col w-full justify-between text-white p-12 md:flex-row">
                    <div className="flex flex-col justify-between pb-5 gap-5 w-full md:w-1/2">
                        ...
                        <div>
                            ...
                            <p className="ml-6">
                                Revendedor validado tem acesso a preço de
                                atacado
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="ml-6">
                                Você pode pagar de forma personalizada no
                                crédito ou pix!
                            </p>{' '}
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-between gap-5 w-full md:w-1/2">
                        <div>
                            ...
                            <p className="ml-6">
                                Poucos minutos após a confirmação de pagamento
                                seu pedido já está a caminho da nossa central.
                            </p>{' '}
                        </div>
                        <div>
                            <h1 className="font-bold text-xl">
                            ...
                            <p className="ml-6">
                                O produto passa pela nossa central de
                                distribuição para conferência e depois segue seu
                                destino com seguro de envio.
                            </p>
                        </div>
                        <div>
                            <h1 className="font-bold text-xl">
                            ...
                            <p className="ml-6">
                                Travamos o repasse do dinheiro para garantir uma
            ...
            <div
                id="OurSite"
                className="w-full pt-20 pb-10 flex flex-col items-center relative md:flex-row"
            >
                ...
                <div className="flex flex-col relative items-center md:items-start">
                    ...
                    <h1 className="text-[7vw] text-white opacity-10 font-extrabold absolute leading-3">
                        #DIFERENTE
                    </h1>
                    ...
                    <div className="flex flex-col justify-between p-4">
                        <div className="flex items-center text-white pt-10">
                            ...
                            <div className="flex flex-col leading-4 ml-2">
                                <h1>
                                    Tenha acesso a preços exclusivos de
                                    revendedor
                                </h1>
                                <h2 className="font-extralight italic">
                                    Seja um revendedor validado para ter acesso
                                    aos melhores preços!
                                </h2>
                            </div>
                        </div>
                        ...
                        <a
                            ...
                            href="https://pedidos.buyphone.com.br/register"
                        >
                            quero me cadastrar
                        </a>
